...
//    	Question 1
        ...
        if (found) 
        {
            JOptionPane.showMessageDialog(null, "True - reset maze and try again");
        }
        else 
        {
            JOptionPane.showMessageDialog(null, "False - reset maze and try again");
        }
...
//     		Question 3
     		...
     		System.out.println("tiny path" + paths);
    }
}
